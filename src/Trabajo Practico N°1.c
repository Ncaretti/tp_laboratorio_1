		...
		switch(opcion)
		{
			...
			case 3:
				...
				else
				{
					...
					reDivision = division(operando1, operando2, &flagDividirCero);
					...
					flagFlotante1 = validarFactorial(operando1, operando2, &flagFlotante2);
			...
			case 4:
				...
				else if(flagModificar1 == 1 || flagModificar2 == 1)
				{
					...
					if(flagFlotante1 == 0 && flagFlotante2 == 0)
					{
						printf("e) El factorial de %.f es %.f y el de %.f es %.f\n\n", operando1, reFactorial1, operando2, punteroFactorial2);
					}
					else if(flagFlotante1 == 1 && flagFlotante2 == 0)
					{
						printf("e) El factorial de %.f es %.f y %.2f no tiene factorial por ser un numero decimal", operando2, punteroFactorial2, operando1);
					}
					else if(flagFlotante1 == 0 && flagFlotante2 == 1)
					{
						printf("e) El factorial de %.f es %.f y %.2f no tiene factorial por ser un numero decimal", operando1, reFactorial1, operando2);
					}
					else
					{
						printf("e) No se puede calcular el factorial ya que ambos numeros son decimales\n");
					}
					system ("pause");
				}
			break;
